...
/**
 * NomCtasxSeccionId generated by hbm2java
 */
public class NomCtasxSeccionId  implements java.io.Serializable {


     private String codSec;
     private String codTran;

    public NomCtasxSeccionId() {
    }

    public NomCtasxSeccionId(String codSec, String codTran) {
       this.codSec = codSec;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NomCtasxSeccionId) ) return false;
		 NomCtasxSeccionId castOther = ( NomCtasxSeccionId ) other; 
