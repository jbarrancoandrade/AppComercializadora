...
/**
 * NomHistorialAportesId generated by hbm2java
 */
public class NomHistorialAportesId  implements java.io.Serializable {


     private String codEmp;
     private Date FCierre;

    public NomHistorialAportesId() {
    }

    public NomHistorialAportesId(String codEmp, Date FCierre) {
       this.codEmp = codEmp;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NomHistorialAportesId) ) return false;
		 NomHistorialAportesId castOther = ( NomHistorialAportesId ) other; 
